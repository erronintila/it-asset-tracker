  ...
  methods: {
    getData: function getData() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _services_AgreementDataService__WEBPACK_IMPORTED_MODULE_0__["default"].getAll(data).then(function (response) {
    ...
    filterAction: function filterAction(action) {
      switch (action) {
        ...
        case "update":
          ...
          this.$router.push("/agreements/" + this.selectedItems[0].id + "/edit");
          break;
    ...
    onDelete: function onDelete() {
      ...
      _services_AgreementDataService__WEBPACK_IMPORTED_MODULE_0__["default"].deleteMany(data).then(function (response) {
        console.log(response.data);
