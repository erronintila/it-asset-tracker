...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    onActivation: function onActivation(is_active) {
      ...
      _services_DepartmentDataService__WEBPACK_IMPORTED_MODULE_0__["default"].activate(data).then(function (response) {
        _this2.getData();
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _c("DepartmentEdit", {
        attrs: {
          department: _vm.selectedItems[0],
          dialogEdit: _vm.dialogDepartmentEdit
        },
        on: {
          "close-dialog": function($event) {
