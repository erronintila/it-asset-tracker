          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return _services_SettingDataService__WEBPACK_IMPORTED_MODULE_2__["default"].getAll({
                  params: {
                    group: "general"
                  }
                });
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.prev = 1;
                _context2.next = 4;
                return _services_SettingDataService__WEBPACK_IMPORTED_MODULE_2__["default"].update(_objectSpread(_objectSpread({}, _this2.form), {
                  group: "general"
                }));
...
var SettingDataService = /*#__PURE__*/function () {
  ...
  _createClass(SettingDataService, [{
    ...
    value: function update(data) {
      return axios__WEBPACK_IMPORTED_MODULE_0___default.a.put("/api/v1/settings/update", data);
    }
  }]);
