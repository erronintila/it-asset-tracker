                              ...
                              _c(
                                ...
                                [
                                  _c("v-data-table", {
                                    attrs: {
                                      "item-key": "id",
                                      headers: _vm.tableAssetOptions.headers,
                                      items: _vm.assets,
                                      loading: _vm.tableAssetOptions.loading,
                                      options: _vm.tableAssetOptions.options,
                                      "server-items-length":
                                        _vm.tableAssetOptions.serverItemsLength,
                                      "footer-props": {
                                        itemsPerPageOptions:
                                          _vm.tableAssetOptions
                                            .itemsPerPageOptions,
