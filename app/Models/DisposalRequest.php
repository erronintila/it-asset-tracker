...
class DisposalRequest extends Model implements HasMedia
{
    ...
    */
    ...
    protected static $logName = "disposal request";

    // // logging description
    public function getDescriptionForEvent(string $eventName): string
    {
        return "{$eventName} disposal request";
    }
    ...
    public function tapActivity(Activity $activity, string $eventName)
    {
        ...
        $activity->properties = $activity->properties->merge([
            'custom' => [
                'section' => 'disposal_requests',
                'section_id' => $this->id,
                // 'causer_role' => $role,
                'link' => "disposal_requests/{$this->id}"
            ],
        ]);
    }
