<template>
    <div>
        <page-header :title="'Checkin Requests'">
    ...
    methods: {
        ...
        getData() {
            ...
            return new Promise((resolve, reject) => {
                ...
                CheckinRequestDataService.getAll(data)
                    .then(response => {
        ...
        onDelete: function() {
            ...
            CheckinRequestDataService.deleteMany(data)
                .then(response => {
                    this.getData();
                    this.selectedItems = [];
                })
        ...
        onRestore: function() {
            ...
            CheckinRequestDataService.restore(data)
                .then(response => {
                    this.getData();
                    this.selectedItems = [];
                })
        ...
        onUpdateStatus(status) {
            ...
            switch (status) {
                case "approve":
                    CheckinRequestDataService.approve(data)
                        .then(response => {
                            this.getData();
                            this.selectedItems = [];
                        })
                    ...
                    break;
                case "complete":
                    CheckinRequestDataService.complete(data)
                        .then(response => {
                            this.getData();
                            this.selectedItems = [];
                        })
                    ...
                    break;
                case "post":
                    CheckinRequestDataService.post(data)
                        .then(response => {
                            this.getData();
                            this.selectedItems = [];
                        })
                    ...
                    break;
                case "cancel":
                    CheckinRequestDataService.cancel(data)
                        .then(response => {
                            this.getData();
                            this.selectedItems = [];
                        })
