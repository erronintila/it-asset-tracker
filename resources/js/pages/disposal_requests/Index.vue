<template>
    <div>
        <page-header :title="'Disposal Requests'">
    ...
    methods: {
        ...
        getData() {
            ...
            return new Promise((resolve, reject) => {
                ...
                DisposalRequestDataService.getAll(data)
                    .then(response => {
        ...
        onDelete: function() {
            ...
            DisposalRequestDataService.deleteMany(data)
                .then(response => {
                    this.getData();
                    this.selectedItems = [];
                })
        ...
        onRestore: function() {
            ...
            DisposalRequestDataService.restore(data)
                .then(response => {
                    this.getData();
                    this.selectedItems = [];
                })
