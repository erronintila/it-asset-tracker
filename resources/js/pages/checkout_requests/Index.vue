<template>
    <div>
        <page-header :title="'Checkout Requests'">
    ...
    methods: {
        ...
        getData() {
            ...
            return new Promise((resolve, reject) => {
                ...
                CheckoutRequestDataService.getAll(data)
                    .then(response => {
        ...
        onDelete: function() {
            ...
            CheckoutRequestDataService.deleteMany(data)
                .then(response => {
                    this.getData();
                    this.selectedItems = [];
                })
        ...
        onRestore: function() {
            ...
            CheckoutRequestDataService.restore(data)
                .then(response => {
                    this.getData();
                    this.selectedItems = [];
                })
        ...
        onUpdateStatus(status) {
            ...
            switch (status) {
                case "approve":
                    CheckoutRequestDataService.approve(data)
                        .then(response => {
                            this.getData();
                            this.selectedItems = [];
                        })
                    ...
                    break;
                case "complete":
                    CheckoutRequestDataService.complete(data)
                        .then(response => {
                            this.getData();
                            this.selectedItems = [];
                        })
                    ...
                    break;
                case "post":
                    CheckoutRequestDataService.post(data)
                        .then(response => {
                            this.getData();
                            this.selectedItems = [];
                        })
                    ...
                    break;
                case "cancel":
                    CheckoutRequestDataService.cancel(data)
                        .then(response => {
                            this.getData();
                            this.selectedItems = [];
                        })
