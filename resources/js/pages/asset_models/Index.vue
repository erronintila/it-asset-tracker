<template>
    <div>
        <page-header :title="'Asset Models'">
    ...
    methods: {
        getData() {
            ...
            return new Promise((resolve, reject) => {
                ...
                AssetModelDataService.getAll(data)
                    .then(response => {
        ...
        filterAction: function(action) {
            switch (action) {
                ...
                case "update":
                    ...
                    this.$router.push(
                        "/asset_models/" + this.selectedItems[0].id + "/edit"
                    );
                    break;
                case "delete":
                    this.onDelete();
        ...
        onActivation(is_active) {
            ...
            AssetModelDataService.activate(data)
                .then(response => {
                    this.getData();
                    this.selectedItems = [];
                })
        ...
        onDelete: function() {
            ...
            AssetModelDataService.deleteMany(data)
                .then(response => {
                    this.getData();
                    this.selectedItems = [];
                })
        ...
        onRestore: function() {
            ...
            AssetModelDataService.restore(data)
                .then(response => {
                    this.getData();
                    this.selectedItems = [];
                })
